...
Route::prefix('store')->name('store.')->group(function () {
    ...
    Route::middleware('auth:store')->group(function () {
        ...
        Route::patch('/menu/edit/image',[StoreImageController::class,'updateGallery'])->name('menu.update.image');
        Route::post('/menu/edit/image', [StoreMenuManegeController::class,'uploadImage'])->name('menu.image.upload');
        Route::delete('/menu/edit/image', [StoreImageController::class, 'deleteImage'])->name('menu.image.delete');       
