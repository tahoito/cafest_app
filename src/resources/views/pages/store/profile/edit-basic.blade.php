                    ...
                    >
                        ...
                        <div class="space-y-1"
                            x-data="{
                                ...
                                this.$root.querySelectorAll('.js-open-day').forEach(cb => cb.checked = checked);
                                }
                            }"
                            >
                            <div class="text-lg text-text_color font-medium">営業曜日</div>

                            <label class="flex items-center gap-3 px-4 py-3 mb-3">
                                <input type="checkbox" @change="toggleAll($event)" class="h-5 w-5 accent-main2">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                ...
                                @foreach($leftDays as $i => $label)
                                    ...
                                    <input
                                        ...
                                        name="open_days[]"
                                        value="{{ $i }}"
                                        class="js-open-day peer h-5 w-5 accent-main2"
                        ...
                        <div class="flex items-center justify-between rounded-lg bg-form px-4 py-3 ring-1 ring-gray-200">
                            ...
                            <select x-model="allOpen"
                                @change="
                                document.querySelectorAll('select[name^=\'hours\'][name$=\'[open]\']')
                                    .forEach(s => s.value = allOpen);
                                "
                            ...
                            <select x-model="allClose"
                                @change="
                                document.querySelectorAll('select[name^=\'hours\'][name$=\'[close]\']')
                                    .forEach(s => s.value = allClose);
                                "
                                class="w-[120px] rounded-lg bg-white px-2 py-2 ring-1 ring-gray-200 text-text_color">
                                <option value="">--:--</option>
                                @foreach($times as $t)
                        ...
                        @foreach($days as $i => $label)
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <option value="">--:--</option>
                                @foreach($times as $t)
                                    <option value="{{ $t }}" @selected(old("hours.$i.open", $openDefault) === $t)>{{ $t }}</option>
                                @endforeach
                                </select>
                                ...
                                <option value="">--:--</option>
                                @foreach($times as $t)
                                    <option value="{{ $t }}" @selected(old("hours.$i.close", $closeDefault) === $t)>{{ $t }}</option>
                                @endforeach
                                </select>
                            </div>
                            </div>
