...
@section('content')
@php
  $initialName = $folderName ?? $title ?? '';
  $updateUrl = !empty($folderId)
            ...
            <div x-data="favoriteFolderHeader(@js($initialName), @js($updateUrl))">
                <header>
                    ...
                    <div class="grid grid-cols-[48px_1fr_48px] items-center px-4 h-16">
                        ...
                        <h1 class="text-center text-text_color text-2xl whitespace-nowrap overflow-hidden text-ellipsis" x-text="name"></h1>
                ...
                @if(!empty($folderId))
                    ...
                    <div class="absolute inset-x-0 bottom-0" @click.stop>
                        ...
                        <div class="px-4 py-4 space-y-3">
                            <button
                            type="button"
                            class="mx-auto block h-12 w-[260px] rounded-full border-2 border-main bg-main text-sm text-form shadow-[0_4px_10px_rgba(0,0,0,0.18)]"
                            ...
                            <button
                            type="button"
                            class="mx-auto block h-12 w-[260px] rounded-full border-2 border-main bg-form text-sm text-text_color shadow-[0_4px_10px_rgba(0,0,0,0.18)]"
                    ...
                    <button class="absolute inset-0 bg-black/40" @click="showEdit=false; error=''"></button>
                    ...
                    <div class="relative h-full w-full grid place-items-center px-6">
                        ...
                        <form @submit.prevent="saveName()" class="mt-6 space-y-6">
                            <x-ui.input
                            type="text"
                            name="name"
                            x-model="name"
                    ...
                    <button type="button" class="absolute inset-0 bg-black/40" @click="showDelete=false" aria-label="Close"></button>

                    <div class="relative h-full w-full grid place-items-center px-6">
                        <div class="relative w-full max-w-sm rounded-2xl bg-form shadow-[0_10px_30px_rgba(0,0,0,0.35)] p-6" @click.stop>
                        <button type="button"
                        ...
                        <div class="pt-8 text-center">
                            <div class="text-text_color text-lg font-medium">コレクションを削除しますか？</div>
                            ...
                            <button type="button" class="w-full text-text_color text-sm" @click="showDelete=false">
                                キャンセル
                            </button>
                            </form>
                        </div>
