  ...
  <div class="{{ $wrap }}">
    ...
    <div class="flex items-start justify-between gap-3">
      <div class="flex items-center gap-3 min-w-0">
        ...
        <div class="min-w-0">
          <div class="text-text_color_color text-[14px] font-semibold truncate">{{ $userName }}</div>
        </div>
      </div>
    ...
    <div class="flex items-center justify-between gap-3">
      <div class="text-text_color_color text-[14px] font-medium truncate">
        {{ $shopName }}
      </div>
    ...
    {{-- 本文 --}}
    <div class="text-text_color_color text-[14px] leading-snug line-clamp-3">
      {{ $body }}
    </div>
