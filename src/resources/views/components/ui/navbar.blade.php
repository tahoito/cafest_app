    ...
    <ul class="absolute inset-x-0 bottom-0 flex items-end justify-center gap-x-10 pb-2 z-30">
      ...
      <li>
        <a href="{{ route('user.top') }}"
          ...
          <span class="{{ $iconBase }}"><x-icons.home size="34" stroke="2.8" class="text-text_color_color" /></span>
        </a>
      </li>
      <li>
        <a href="{{ route('user.search') }}"
          ...
          data-i="0">
          <span class="{{ $circleBase }}"></span>
          <span class="{{ $iconBase }}"><x-icons.search size="34" stroke="2.8" class="text-text_color_color" /></span>
        </a>
      </li>
      <li><button class="{{ $btnBase }} {{ $btnSize }}" data-i="2" type="button"><span class="{{ $circleBase }}"></span><span class="{{ $iconBase }}"><x-icons.reserve size="34" stroke="2.8" class="text-text_color_color" /></span></button></li>
      <li><button class="{{ $btnBase }} {{ $btnSize }}" data-i="3" type="button"><span class="{{ $circleBase }}"></span><span class="{{ $iconBase }}"><x-icons.mycafe size="34" stroke="2.8" class="text-text_color_color" /></span></button></li>
    </ul>
